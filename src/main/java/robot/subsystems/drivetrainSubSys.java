...
public static VictorSPX leftFrontMotor;
public static VictorSPX leftBackMotor;
public static VictorSPX rightFrontMotor;
public static VictorSPX rightBackMotor;
...
// driveCtrl.setMaxOutput(1.0);
    ...
    */
    ...
    public void periodic() {
        ...
        double speedInput = robot.RobotContainer.getLeftStickY();
        double turnInput = robot.RobotContainer.getTriggerDifference();

        // send those values to the drive train
        arcadeDrive(speedInput, turnInput);
    }
